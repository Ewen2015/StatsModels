...
<img src="http://www.sciweavers.org/tex2img.php?eq=x_t%20%3D%20%5Cphi%20x_%7Bt-1%7D%20%2B%20w_t&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="x_t = \phi x_{t-1} + w_t" width="131" height="19" />

where <img src="http://www.sciweavers.org/tex2img.php?eq=%5C%7Bw_t%5C%7D&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="\{w_t\}" width="47" height="18" /> are **uncorrelated** random variables with **mean 0 and finite variance**, and called **white noise**. If white noises are independent, they are called iid noise, which are not required here. More details about independence and uncorrelated will be discussed later. 

According to different values of <img src="http://www.sciweavers.org/tex2img.php?eq=%5Cphi&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="\phi" width="17" height="19" />, the autoregressive models (AR) have specific names.

|<img src="http://www.sciweavers.org/tex2img.php?eq=%5Cphi&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="\phi" width="17" height="19" />|AM Type |
|---|---|
|=0| White Noise|
|absolute value < 1| Stationary AM|
|=1| Random Walk|
|>1| Explosion|
